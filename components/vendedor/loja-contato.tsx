// Contato da loja exibido na tarja (catalogo e galeria publica): WhatsApp + telefone.
export function LojaContato() {
  return (
    <div className="loja-contato">
      <a
        className="loja-contato-item"
        href="https://wa.me/5513974069303"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="WhatsApp (13) 974069303"
      >
        ...
        <span>(13) 974069303</span>
      </a>
      <a className="loja-contato-item" href="tel:+551334744560" aria-label="Telefone (13) 3474-4560">
        <svg viewBox="0 0 24 24" aria-hidden="true" width="20" height="20">
          <path
            fill="currentColor"

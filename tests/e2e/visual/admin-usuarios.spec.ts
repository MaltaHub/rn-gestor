...
test.describe("visual baseline / admin/usuarios", () => {
  test("estado base", async ({ page }) => {
    await installApiMocks(page);
    await signInAsDevRole(page, "ADMINISTRADOR", { next: "/admin/usuarios" });
    await expectStableScreenshot(page, "admin-usuarios-base.png");
  });
});

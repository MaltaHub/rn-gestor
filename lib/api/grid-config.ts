...
const GRID_TABLES: Record<GridTableName, GridTableConfig> = {
  ...
  vendas: defineGridTableConfig("vendas", {
    ...
    defaultHeader: [
      ...
      "cartao_parcelas_qtde",
      "cartao_parcela_valor",
      "tipo_transferencia",
      "valor_transferencia",
      "debitos",
      "estado_venda",
    ...
    // valor_entrada e denormalizado (soma de venda_entradas, trigger no banco).
    ...
    columnTypes: {
      ...
      comprador_cidade_estado: "string",
      ...
      cartao_parcelas_qtde: "number",
      cartao_parcela_valor: "number",
  ...
  venda_entradas: defineGridTableConfig("venda_entradas", {
    label: "Entradas de venda",
    primaryKey: "id",
    defaultHeader: [
      "id",
      "venda_id",
    ...
    searchableColumns: ["tipo", "descricao", "venda_id", "carro_troca_id"],

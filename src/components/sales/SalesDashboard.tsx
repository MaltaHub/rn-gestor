        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {salesMetrics?.vendasDetalhadas?.slice(0, 5).map((venda: any) => (
                <div key={venda.id} className="flex justify-between items-center py-2 border-b">
                  <div>
                    <p className="font-medium">{venda.vehicles?.model}</p>
                    <p className="text-sm text-gray-500">{venda.vehicles?.plate}</p>
                  </div>

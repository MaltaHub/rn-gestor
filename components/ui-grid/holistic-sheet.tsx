...
import { PrintDialog } from "@/components/ui-grid/dialogs/print-dialog";
...
export function HolisticSheet({
  ...
  const printExport = useGridPrintExport();
  const {
    printDialogOpen,
    setPrintDialogOpen,
    printTitle,
    ...
    <main className="sheet-shell" data-testid="holistic-sheet">
      ...
      {advancedOpen ? (
        <AdvancedDataDialog
          ...
          primaryKey={activeSheet.primaryKey}
          readerColumns={allColumns}
          ...
          onSelectRows={(ids) => setSelectedRows(new Set(ids))}
          onApplied={() => {
            void loadGrid();
          }}
      ...
      <PrintDialog
        ...
        printActiveTemplateId={printActiveTemplateId}
        printAnchorFilter={printAnchorFilter}
        setPrintAnchorFilter={setPrintAnchorFilter}
        printAnchorPopoverOpen={printAnchorPopoverOpen}
        setPrintAnchorPopoverOpen={setPrintAnchorPopoverOpen}
        printColumnReferenceOrder={printColumnReferenceOrder}
        printFilterTriggerRefs={printFilterTriggerRefs}
        printSectionOptions={printSectionOptions}
        printHighlightPreview={printHighlightPreview}
        printableRows={printableRows}
        printPreviewColumns={printPreviewColumns}
        printPreviewRows={printPreviewRows}
        printDirty={printDirty}
        printSavingTemplate={printSavingTemplate}
        isPrintTableScope={isPrintTableScope}
        allColumns={allColumns}
        rows={payload.rows}
        selectedRows={selectedRows}
        getPrintColumnLabel={getPrintColumnLabel}
        resolveEffectivePrintValue={resolveEffectivePrintValue}
        handleGeneratePrint={handleGeneratePrint}
        handleSelectTemplate={handleSelectTemplate}
        handleClickNewTemplate={handleClickNewTemplate}
        handleClickResetComposer={handleClickResetComposer}
        handleClickDeleteTemplate={handleClickDeleteTemplate}
        handleClickSaveTemplate={handleClickSaveTemplate}
        addPrintHighlightRule={addPrintHighlightRule}
        updatePrintHighlightRule={updatePrintHighlightRule}
        removePrintHighlightRule={removePrintHighlightRule}
        openPrintFilterPopover={openPrintFilterPopover}
        closePrintFilterPopover={closePrintFilterPopover}
      />
      <BulkSelectDialog

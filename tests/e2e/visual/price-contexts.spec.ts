...
test.describe("visual baseline / price-contexts", () => {
  test("estado base", async ({ page }) => {
    await installApiMocks(page);
    await signInAsDevRole(page, "ADMINISTRADOR", { next: "/price-contexts" });
    await expectStableScreenshot(page, "price-contexts-base.png");
  });
});
